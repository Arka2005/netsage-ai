"""One firing test per rule (R01-R14), using text shaped like the real dataset's show_outputs.

This is a smoke-test pass to catch regex/logic bugs while building the rule engine (Phase 2).
The exhaustive fire + non-fire fixture per rule (NFR-06) is Phase 3's job, not this file's.
"""
...
def test_r07_native_vlan_mismatch():
    text = (
